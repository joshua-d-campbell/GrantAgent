...
Confirm with the user: PI(s), co-Is, postdocs, students, staff, consultants, subaward sites. For each person: role, effort (person-months or %), and which aims they serve. Flags to raise factually:
...
- NIH modular (≤$250K direct/year, R01-class): budget in $25K modules; justification covers personnel and any module-count variations only. Detailed line items still needed internally for the grants office.
- NIH detailed (R&R form): full justification per category per year.
