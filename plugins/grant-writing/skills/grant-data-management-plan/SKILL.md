...
Required at NIH for essentially all research generating scientific data (policy effective January 2023) and at NSF for all proposals. Program staff review NIH DMSPs; weak plans generate administrative back-and-forth, and the plan becomes a term of award — do not promise practices the lab will not follow.
...
Budget note: data curation and repository costs are allowable — coordinate line items with `grant-budget-justification`.
